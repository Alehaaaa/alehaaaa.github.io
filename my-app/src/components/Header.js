      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-10">
            <a href="#projects" className="text-base text-black hover:opacity-80 transition-colors">
              Projects
            </a>
            <a href="#about" className="text-base text-black hover:opacity-80 transition-colors">
              About
            </a>
            <a href="#contact" className="text-base text-black hover:opacity-80 transition-colors">
              Contact
            </a>
          </nav>
          <button
