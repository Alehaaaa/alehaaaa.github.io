    ...
    <section className="relative bg-background py-10 md:py-24">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mt-16 text-left">
          <h1 className="text-5xl md:text-7xl lg:text-9xl font-black text-foreground uppercase leading-[1.0]">
            I'm Alejandro<br />
            and I animate.
          </h1>
          <p className="mt-6 text-4xl md:text-6xl font-medium border-l-4 border-[color:var(--neo-border)] pl-6 text-foreground">
